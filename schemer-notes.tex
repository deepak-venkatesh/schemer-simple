...
\item Without looking into the questions we are able to build these \texttt{cons}-es for \texttt{insertR}, \texttt{insertL}, and \texttt{subst}.
\begin{verbatim}
(define insertR
  (lambda (new old lat)
    (cond ((null? lat) (quote ()))
