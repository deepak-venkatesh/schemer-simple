...
be tested first for the base condition. This is so because when \texttt{n} reaches zero we know for sure that \texttt{n} is \texttt{<=> \textasciitilde{}m} thus the overall test
